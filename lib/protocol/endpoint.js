...
Endpoint.prototype._write = function _write(chunk, encoding, done) {
  // 有write写入事件，先写入到_deserializer，以此pipe，最后到_connection
...
// 底下这些代码是搞什么的？
// 感觉和log 后面的（e=1) 之类的有关。因为.....直觉。
// 就是这玩意: [2015-04-29T08:23:54.020Z]  INFO: server/http/12156 on lcj-PC: Sending server response (e=17, s=35, status=200)
// Stream.js 内的类似东西。exports.serializers.s = function(stream) {
  // 玩不下去了，那么的红杏google上不去了。
  // 懂!!!
  // 看my.js - formatter unittest 
// Bunyan serializers
// ------------------
